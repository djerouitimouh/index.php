...
// Préparation de la requête SQL pour récupérer les demandes avec les noms des personnes filtrées par nom_service = 'Service Recette'
    ...
    <link rel="stylesheet" href="../../public/css/style1.css">
       ...
       <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Code pour charger les notifications non lues via AJAX
...
<header>
   ...
   <div class="search-bar">
    <div class="container">
        <form method="POST" action="les_demandes_recette.php">
    ...
    <div class="demandes">
        <div class="container">
            <?php
            if (empty($demandes)) {
                echo "<div class='demande-card'><h3>Il n'y a pas de demande</h3></div>";
            } else {
