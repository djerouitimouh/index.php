...
<head>
    ...
    <title>Service Principal de Gestion</title>
    ...
    <script>
        ...
        function showDemandes(type) {
            window.location.href = `les_demandes_gestion_refuser.php?type=${type}`;
        }
    </script>
</head>
<body>
...
<div class="search-bar">
    <div class="container">
        <form method="GET" action="les_demandes_gestion_refuser.php">
