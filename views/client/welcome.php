<?php
    ...
    $stmt->execute(['id' => $id]);
    $compte = $stmt->fetch(); // Fetch a single row

    // Check if $compte is not empty
    if (!$compte) {
        // Handle case where no account is found for the given ID
        echo "No account found!";
        exit(); // Ensure script stops executing after handling error
    }
    $user_id = $_SESSION['id'];
