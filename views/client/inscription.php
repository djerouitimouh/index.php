...
<header>
    <div class="container">
        <div class="logo">
            <img src="../../public/images/logo1.png" alt="impot">
        </div>
        <nav class="bienvenue">
        <p>République Algérienne Démocratique et Populaire <br> Ministre Des Finances<br> Centre des Impôts</p>
        </nav>
        <div class="Home">
            <ul>
...
<div class="inscription">
    ...
    <form action="../../control/inscription.php" method="post" class="form1">
        
            <input  class="un" type="text" id="nom" name="nom" placeholder="nom">
            <input  class="un" type="text" id="prenom" name="prenom" placeholder="prenom" required>
            <input  class="un" type="text" id="username" name="username" placeholder="username" required>

            <select class="un" id="sexe" name="sexe" aria-placeholder="sexe" required>
                <option value="homme">Homme</option>
                <option value="femme">Femme</option>
                <option value="autre">Autre</option>
            </select>
            <input  class="un" type="date" id="dateNaissance" name="dateNaissance" placeholder="date_de_naissence" required>
            <input class="un" type="email" id="email" name="email" placeholder="email" required>
            <input class="un" type="password" id="motDePasse" name="motDePasse" placeholder="mot de pass" required>
            <input class="un" type="password" id="confirmMotDePasse" name="confirmMotDePasse" placeholder="confirmer votre mot de passe" required>
            <button class="submit" type="submit" name="submit">S'inscrire</button>
            
            <p class="forgot"><a href="connexion.php">Connexion</a></p>
